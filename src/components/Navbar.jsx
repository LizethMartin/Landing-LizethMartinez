...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 flex nav-center items-center content-center  lg:fixed lg:inset-x-0 lg:bottom-0 shadow-[0px_4px_58px_-15px_#262626]">
            ...
            >
              <ul className="flex flex-col   text-center  lg:flex-row  list-none lg:ml-auto ">
                <li className="nav-item">
                  <Link to="../home"
                    className="px-3 py-2 flex items-center text-xs uppercase font-regular leading-snug text-gray-500 hover:text-red-800 hover:font-bold"
                    href="../home"
                  >
